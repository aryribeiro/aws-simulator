...
st.set_page_config(page_title="AWS Simulator (SAA-C03)", page_icon="📝", layout="centered")
st.title("📝 AWS Simulator")
st.markdown("Simulado AWS **SAA-C03** 2025, com 65 perguntas.🚀")
